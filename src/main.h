...
static const int64_t MAX_MONEY = 5500000 * COIN;
static const int64_t COIN_YEAR_REWARD = 1 * CENT; // 1% per year
static const int64_t MAX_MINT_PROOF_OF_STAKE = 0.11 * COIN;	// 11% annual interest
...
public:
    ...
    {
        // REITIS: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // REITIS: get transaction coin age
...
public:
    ...
    // REITIS: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // REITIS: two types of block: proof-of-work or proof-of-stake
    ...
    // REITIS: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // REITIS: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // REITIS: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // REITIS: block index flags
    enum  
    {
