...
namespace Checkpoints
{
    ...
    // REITIS: synchronized checkpoint (centrally broadcasted)
    ...
    // REITIS: get last synchronized checkpoint
    ...
    // REITIS: only descendant of current sync-checkpoint is allowed
    ...
    // REITIS: reset synchronized checkpoint to last hardened checkpoint
...
// REITIS: sync-checkpoint master key
...
// REITIS: verify signature of sync-checkpoint message
...
// REITIS: process synchronized checkpoint
