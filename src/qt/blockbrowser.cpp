...
{
    if(Height > pindexBest->nHeight) { return "000006feab4a9e0a0c30f637349118412ddfa6eeab071590bd23b7b9a4dce009"; }
    if(Height < 0) { return "000006feab4a9e0a0c30f637349118412ddfa6eeab071590bd23b7b9a4dce009"; }
    int desiredheight;
...
{    
    ...
    if(block == false) {
        ...
        ui->valueBox->setText(QValue + " XREI");
        ui->txID->setText(QID);
        ui->outputBox->setText(QOutputs);
        ui->inputBox->setText(QInputs);
        ui->feesBox->setText(QFees + " XREI");
    }
}
