...
{
    // Convert REITIS:// to REITIS:
    //
    //    Cannot handle this later, because bitcoin:// will cause Qt to see the part after // as host,
    //    which will lower-case it (and thus invalidate the address).
    if(uri.startsWith("REITIS://"))
    {
        uri.replace(0, 12, "REITIS:");
    }
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "REITIS-Core";
}
...
{
    return GetAutostartDir() / "REITIS-Core.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("REITIS-Core") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  REITIS-Core [" + tr("command-line options") + "]                     " + "\n";
...
{
    app.setStyleSheet("QTableView { color: rgb(255,255,255); alternate-background-color: rgb(40,86,86); background-color: rgb(40,86,86); gridline-color: rgb(90,104,118); }"
                      "QWidget        { background-color: rgb(40,86,86); color: rgb(255,255,255); }"
                      ...
                      "QPushButton    { 40 color: rgb(255,255,255); }"
                      "QMenuBar       { background-color: rgb(40,86,86); color: rgb(255,255,255); }"
                      "QMenu          { background-color: rgb(40,86,86); color: rgb(255,255,255); }"
                      "QMenuBar::item {background-color: transparent;}"
                      "QMenu::item:selected { background-color: rgb(40,86,86); }"
                      "QTreeView::item { background-color: rgb(40,86,86); }"
                      "QTreeView::item:selected { background-color: rgb(40,86,86); }"
                      "QHeaderView::section { background-color: rgb(40,86,86); color: rgb(255,255,255); }"
                      "QToolBar       { background-color: rgb(40,86,86); border: none; }"
                      "QTextEdit      { background-color: rgb(40,86,86); color: rgb(255,255,255); }"
                      "QPlainTextEdit { background-color: rgb(178,178,178); color: rgb(255,255,255); }"
                      "QComboBox      { background-color: rgb(40,86,86); color: rgb(255,255,255); }"
                      "QComboBox QAbstractItemView::item { color: rgb(40,86,86); }"
